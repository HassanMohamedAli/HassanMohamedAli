...
function init_chart_payment_doughnut()
{
    ...
    if ($('.canvasPaymentDoughnut').length) {

        var chart_payment_doughnut_settings = {
            type: 'doughnut',
        ...
        $('.canvasPaymentDoughnut').each(function () {

            var chart_element = $(this);
            var chart_doughnut = new Chart(chart_element, chart_payment_doughnut_settings);
...
function init_wysiwyg() {
    function a(e, a) {
        var t = "";
        "unsupported-file-type" === e ? t = "Unsupported format " + a : console.log("error uploading file", e, a), $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">×</button><strong>File upload error</strong> ' + t + " </div>").prependTo("#alerts")
    }
